    ...
    private void castSpellAttack(Attack castSpell)
    {
        ...
        switch (castSpell.mShape)
        {
            ...
            case Shape.Circle:
                ...
                foreach (GameObject fx in listFX)
                {
                    ...
                    else
                    {
                        ...
                        ((Circle)castSpell).mStep = (((Circle)castSpell).targetFX - this.gameObject.transform.position) / (castSpell.mTimeLifeSpell*0.90f);
                    }
                }
            ...
            case Shape.Line:
                ...
                instanceSpell.GetComponent<OnCollisionEnterLine>().setNameSpell(castSpell.mName);
